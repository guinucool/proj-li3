...
/// @brief A função createCity cria uma estrutura City.
/**
 ...
 * 
 *  @return Pointer da estrutura City criada e alocada.
 */ 
...
/// @brief A função updateCity atualiza uma estrutura City.
/**
 ...
 *  o espaço ocupado por esta e pelas suas propriedades.
 * 
